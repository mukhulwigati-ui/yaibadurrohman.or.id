...
import { Smartphone, Check, Copy, ArrowRight, TrendingUp, Users, AlertCircle, Clock, Loader2 } from 'lucide-react';
        ...
        <div className="space-y-4 pt-2 border-t border-gray-100 animate-in fade-in duration-200">
          ...
          <div className="bg-slate-50 border border-slate-200/70 p-4 space-y-3 rounded-xl">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className={`text-[10px] font-bold px-2.5 py-0.5 uppercase rounded-full tracking-wide text-white ${stats.profile.status === 'approved' ? 'bg-emerald-600' : 'bg-amber-500'}`}>
